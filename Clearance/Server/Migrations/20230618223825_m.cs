        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnivNum = table.Column<int>(type: "int", nullable: false),
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OrderApplyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    State = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderRecieveDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clearances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Clearances_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Clearances_Collages_CollageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clearances_CollageId",
                table: "Clearances",
                column: "CollageId");

            migrationBuilder.CreateIndex(
                name: "IX_Clearances_NationalNum",
                table: "Clearances",
                column: "NationalNum",
                unique: true);
